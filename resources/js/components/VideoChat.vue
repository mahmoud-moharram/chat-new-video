...
export default {
    ...
    methods: {
        initializeChannel() {
            this.videoCallParams.channel = window.Echo.join("video-channel");
        ...
        async placeVideoCall(id, name) {
            ...
            this.videoCallParams.peer1.on("close", () => {
                console.log("call1 closed caller");
            });
        ...
        async acceptCall() {
            ...
            this.videoCallParams.peer2.on("close", () => {
                console.log("call2 closed accepter");
            });
        ...
        toggleMuteVideo() {
            if(this.$refs.userVideo.srcObject.getVideoTracks()[0]){
                if (this.mutedVideo) {
